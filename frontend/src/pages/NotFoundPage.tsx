    ...
    <StoreShell>
      <div className="mt-24 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link
            to="/"
            className="inline-grid h-11 place-items-center rounded-lg bg-acid px-6 font-display text-sm font-semibold text-ink"
          >
            Início
          </Link>
          <Link
            to="/catalogo"
            className="inline-grid h-11 place-items-center rounded-lg px-6 font-mono text-[11px] text-zinc-200 uppercase ring-1 ring-line"
          >
            Catálogo
          </Link>
          <Link
