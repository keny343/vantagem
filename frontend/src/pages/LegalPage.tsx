...
const PAGINAS: Record<string, { titulo: string; corpo: string[] }> = {
  ...
  '/termos': {
    ...
    corpo: [
      ...
      'Métodos de pagamento: Multicaixa Express, referência Multicaixa e transferência bancária. Enquanto o operador de pagamentos de produção não estiver ligado, as confirmações são simuladas e nenhum débito real ocorre.',
